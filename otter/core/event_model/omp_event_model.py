...
def combine_graphs(event_model: OMPEventModel, task_registry: TaskRegistry, graphs: Iterable[Graph]) -> Graph:
    ...
    strategies['event'] = combine_attribute_strategy(handlers.return_unique_single_executor_event)

    graph.contract_vertices(labeller.label(graph.vs), combine_attrs=strategies)
    ...
    strategies['event'] = combine_attribute_strategy(handlers.return_unique_master_event)
    ...
    ********************************************************************************
    ...
    strategies['event'] = combine_attribute_strategy(handlers.reject_task_create)
    ...
    strategies['_task_cluster_id'] = combine_attribute_strategy(handlers.pass_the_set_of_values,
                                                                accept=tuple,
    ...
    strategies['event'] = combine_attribute_strategy(handlers.pass_args)
